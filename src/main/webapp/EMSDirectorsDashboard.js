try {
	window.onload = function() {
		...
		xhr1.open('PUT', 'http://192.168.1.201:8080/EMS/EMSItemListServlet', true);
		...
		xhr2.open('PUT', 'http://192.168.1.201:8080/EMS/EMSDirectorsDashboardServlet', true);
		...
		xhr3.open("PUT", "http://192.168.1.201:8080/EMS/EMSDispatchItemsListServlet", true);
		xhr3.onload = () => {
			if (xhr3.status == 200) {
