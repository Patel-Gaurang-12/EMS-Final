function getNotification() {
	...
	xhr.open('PUT', 'http://192.168.1.201:8080/EMS/EMSDirectorsDashboardServlet', true);
	xhr.onload = function() {
		if (xhr.status === 200) {
...
function getNotificationForPayment(){
	...
	xhr1.open('PUT', 'http://192.168.1.201:8080/EMS/EMSDirectorsDashboardServlet', true);
...
function deleteNotification(vendorName){
	...
	let data1;
	var xhr = new XMLHttpRequest();
	xhr.open('DELETE', 'http://192.168.1.201:8080/EMS/EMSDirectorsDashboardServlet', true);
	xhr.onload = function() {
		if (xhr.status === 200) {
