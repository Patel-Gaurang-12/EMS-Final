window.onload = function getProject1() {
	...
	xhr.open('PUT', 'http://192.168.1.201:8080/EMS/EMSProductionServlet',true);
	...
	xhr1.open('GET', 'http://192.168.1.201:8080/EMS/EMSQuotationPerItemServlet', true);
...
function getOffers() {
	let Data;
	var xhr = new XMLHttpRequest();
	xhr.open('PUT', 'http://192.168.1.201:8080/EMS/EMSDrawingServlet', true);
...
document.getElementById("categoryId").addEventListener("change", () => {
	let gradeData;
	var xhr = new XMLHttpRequest();
	xhr.open('PUT', 'http://192.168.1.201:8080/EMS/EMSQuotationPerItemServlet', true);
	xhr.setRequestHeader('Content-type', 'application/json');
	xhr.onload = function() {
		if (xhr.status === 200) {
...
function submitForm1() {
	console.log(data)
	var xhr = new XMLHttpRequest();
	xhr.open('POST', 'http://192.168.1.201:8080/EMS/DailyProgressReportServlet', true);
	xhr.setRequestHeader('Content-type', 'application/json');
	xhr.onreadystatechange = function() {
		if (xhr.status == 200) {
